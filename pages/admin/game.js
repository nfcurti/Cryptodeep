...
export default class Home extends React.Component {
  ...
  _editGeneralSettings = () => {
    if(this.state.formController.predictionaward.length == 0) {
      return alert('Prediction Award is empty');
    }

    if(isNaN(this.state.formController.predictionaward)) {
      return alert('Prediction Award should be a number');
    }
