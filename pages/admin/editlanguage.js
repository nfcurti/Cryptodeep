...
export default class Home extends React.Component {
            ...
            window.location.replace(`/account`)
                ...
                ServiceAuth.getlanguagedataset({
                    ...
                    if(data.data.items != null) {
                        ...
                        _fC.descriptionhelper = _itemX.descriptionhelper;
                        _fC.en = _itemX.en;
                        _fC.es = _itemX.es;
                        _fC.it = _itemX.it;
                        _fC.ru = _itemX.ru;
  ...
  addReviewPressed = () => {
    ...
    if(userCookies['ckuserid'] == null || userCookies['cktoken'] == null) {
      ...
      const _mTSZ = {
        'token': userCookies['cktoken'],
        'codemsg': this.state.item.codemsg,
        'descriptionhelper': this.state.formController.descriptionhelper,
        'en': this.state.formController.en,
  ...
  return (
        ...
        <div className='bp-middle-all bp-blueshadow'>
                <p className='loginTitle'>Edit Language</p>
        ...
        <div className='inputhold'>
            <p style={{fontSize: '18px'}}>Help Description: <br/><input name='descriptionhelper' style={{height: '10px',
            width: '90%'
        }} type='text' onChange={this.handleInputChange} value={this.state.formController.descriptionhelper}/></p>
        </div>
        <div className='inputhold'>
            <p style={{fontSize: '18px'}}>En: <br/><input name='en' style={{height: '10px',
            width: '90%'
        }} type='text' onChange={this.handleInputChange} value={this.state.formController.en}/></p>
        </div>
        <div className='inputhold'>
            <p style={{fontSize: '18px'}}>Es: <br/><input name='es' style={{height: '10px',
            width: '90%'
        }} type='text' onChange={this.handleInputChange} value={this.state.formController.es}/></p>
        </div>
        <div className='inputhold'>
        ...
        <div className='inputhold'>
            ...
            width: '90%'
        }} type='text' onChange={this.handleInputChange} value={this.state.formController.ru}/></p>
        </div>
        <div className='inputhold'>
            <p style={{fontSize: '18px'}}>Hi: <br/><input name='hi' style={{height: '10px',
            width: '90%'
        }} type='text' onChange={this.handleInputChange} value={this.state.formController.hi}/></p>
        </div>
