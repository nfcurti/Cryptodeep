...
export default class Home extends React.Component {
            ...
            window.location.replace(`/cryptodeep/account`)
                ...
                ServiceAuth.getaffcontesthistory({
                    ...
                    if(data.data.items != null) {
                        ...
                        _fC.totalpoints = _itemX.totalpoints;
                        this.setState({
                            item: _itemX,
                            formController: _fC
                        })
  ...
  addReviewPressed = () => {
    ...
    if(userCookies['ckuserid'] == null || userCookies['cktoken'] == null) {
      ...
      const _mTSZ = {
        'token': userCookies['cktoken'],
        'affcontestid': this.state.item._id,
        'totalpoints': this.state.formController.totalpoints,
      }
      console.log(_mTSZ);
  ...
  return (
        ...
        <div className='bp-middle-all bp-blueshadow'>
                {this.state.item == null ? null : <p className='loginTitle'>Affiliation Contest - Edit {this.state.item.username} points</p>}
        ...
        <div className='inputhold'>
            <p style={{fontSize: '18px'}}>Total Points: <br/><input name='totalpoints' style={{height: '10px',
            width: '90%'
        }} type='number' onChange={this.handleInputChange} value={this.state.formController.totalpoints}/></p>
        </div>
