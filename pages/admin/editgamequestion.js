...
export default class Home extends React.Component {
            ...
            window.location.replace(`/account`)
                ...
                ServiceAuth.getgamequestions({
                    ...
                    if(data.data.items != null) {
                        ...
                        _fC.correctoption = _itemX.correctoption;
                        _fC.optiona = _itemX.optiona;
                        _fC.optionb = _itemX.optionb;
                        _fC.optionc = _itemX.optionc;
                        _fC.optiond = _itemX.optiond;
                        this.setState({
                            item: _itemX,
                            formController: _fC
                        })
  ...
  return (
        ...
        <div className='bp-middle-all bp-blueshadow'>
                <p className='loginTitle'>Edit Game Question</p>
