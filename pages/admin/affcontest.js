...
export default class Home extends React.Component {
  ...
  return (
        ...
        <div className='bp-middle-all bp-blueshadow'>
                <p className='loginTitle'>Admin Affiliation Contest</p>
                {/* <input
                style={{
                  marginTop: '140px'
                }}
                ...
                <td style={{width: '15em', textAlign:'left',letterSpacing:'2px'}}><p>{item.totalpoints}</p></td>
